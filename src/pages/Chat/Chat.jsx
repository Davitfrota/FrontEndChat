...
const Chat = props => {
  ...
  //meta title
  document.title = "Conversas | Nova Onda";
  ...
  return (
    <React.Fragment>
      <div className="page-content">
        <Container fluid>
          {/* Render Breadcrumb */}
          <Breadcrumbs title="Nova Onda" breadcrumbItem= {props.t("Chat")} />
                      ...
                      <Nav pills justified>
                        ...
                        <NavItem>
                         ...
                         <NavItem >
                          ...
                          >
                            <span disable className="d-none d-sm-block">{props.t("Contacts")}</span>
                          </NavLink>
                        </NavItem>
                      </Nav>
